 ...
 * Static-shell PWA: app.html + manifest + icons are precached.
...
const SHELL = [
  '/app.html',
  '/index.html',  // also cache index.html (served as the default on most hosts)
  '/manifest.json',
  '/icon.svg',
];
  ...
  if (req.mode === 'navigate' || (req.headers.get('accept') || '').includes('text/html')) {
    event.respondWith((async () => {
      try {
        ...
        const cached = await caches.match('/app.html') || await caches.match('/index.html');
